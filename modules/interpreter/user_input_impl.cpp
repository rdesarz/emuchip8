...
SDLKeyboardUserInputController::SDLKeyboardUserInputController(const SDLInputToKeyMap& input_to_key_map) : m_input_to_key_map(input_to_key_map)
{
...
std::optional<InputState> SDLKeyboardUserInputController::getInputState(InputId input_id)
{ 
...
bool TestUserInputController::setInputState(InputId input_id, InputState input_state)
{
    try
    {
...
std::optional<InputState> TestUserInputController::getInputState(InputId input_id)
{
    try
    {
